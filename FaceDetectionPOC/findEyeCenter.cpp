...
void findEyeCenter(cv::Mat eyeROIUnscaled, cv::Rect eye, cv::Point& pupil) {
    cv::transpose(eyeROIUnscaled,eyeROIUnscaled);
    cv::flip(eyeROIUnscaled,eyeROIUnscaled,1);
  //cv::Mat eyeROIUnscaled = face(eye);
    cv::Mat eyeROI(eyeROIUnscaled);
  ...
  cv::Mat gradientX, gradientY, absGradientX, absGradientY; //, magGradient, normMagGradient;

    cv::Scharr(eyeROI, gradientX, CV_64F, 1, 0, 1, 0, cv::BORDER_DEFAULT);
    cv::Scharr(eyeROI, gradientY, CV_64F, 0, 1, 1, 0, cv::BORDER_DEFAULT);
